...
function About() {
    return (
        <>
            <div id="about" className=" w-full flex justify-between mt-30  mb-30     h-[60vh] py-15 px-15 " >
                <div className="animate-(--animate--out) w-full mr-3 p-5  relative  ">
                ...
                <div className="w-4 h-full bg-primary-dark animate-(--animate--down-lt) relative left-5 "></div>
